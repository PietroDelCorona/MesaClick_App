            ...
            <section className="container mx-auto py-12 px-4">
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-6 items-center"> 
                    ...
                    <Image 
                        ...
                        alt="Carrinho de compras inteligente"
                        fill
                    ...
                    <Link href="/register" className="inline-block">
                        <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg text-lg transition-all w-full md:w-auto
