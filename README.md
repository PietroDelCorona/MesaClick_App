...
#### Página do Dashboard
![Página do Dashboard](images_system/dashboard_page.png)

#### Página da Agenda 
![Página da Agenda](images_system/agenda_recipes.png)

#### Página da Lista de Datas Compiladas
![Página da Lista de Datas Compiladas](images_system/agenda_list.png)

#### Página Formulário de Receitas
![Página Formulário de Receitas](images_system/form_create_recipe.png)

#### Página Receitas por Usuário
![Página Receitas por Usuário](images_system/receitas_user_id.png)

#### Página Lista
![Página Lista](images_system/shopping_list_id.png)

#### Mapa dos supermercados próximos
![Mapa dos supermercados próximos](images_system/markets_nearby_map.png)
...
erDiagram
    User ||--o{ Recipe : owner
    User ||--o{ ShoppingList : owner
    User ||--o{ Schedules : user

    Recipe ||--o{ RecipeIngredient : ingredients
    Recipe ||--o{ RecipeStep : steps
    Recipe ||--o{ Schedules : recipe

    ShoppingList ||--o{ ShoppingListItem : items
    ShoppingList }|--|| Supermarkets : supermarket
